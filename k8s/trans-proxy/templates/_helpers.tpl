...
Common labels
*/}}
{{- define "trans-proxy.labels" -}}
app.kubernetes.io/name: {{ include "trans-proxy.name" . }}
helm.sh/chart: {{ include "trans-proxy.chart" . }}
...
*/}}
{{- define "trans-proxy.hostPrefix" -}}
{{- $name := include "trans-proxy.name" . -}}
