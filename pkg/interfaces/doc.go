...
business on the other. Here we trans-proxyform information from the outside world to
business objects and internal replies to their corresponding outside world
representation.

What lives here

As an intermediary, here is where most trans-proxylation code dwells. HTTP Handlers
